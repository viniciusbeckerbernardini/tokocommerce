...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/06/2019 às 05:22
...
INSERT INTO `tb_carts` (`idcart`, `dessessionid`, `iduser`, `deszipcode`, `vlfreight`, `nrdays`) VALUES
(7, '177h6tftv8enmmrjtm5qhsi7ff', NULL, NULL, NULL, NULL);
...
INSERT INTO `tb_ordersstatus` (`idstatus`, `desstatus`) VALUES
(1, 'Em Aberto'),
...
INSERT INTO `tb_persons` (`idperson`, `desperson`, `desemail`, `nrphone`) VALUES
(1, 'JoÃ£o Rangel', 'admin@hcode.com.br', 2147483647),
(7, 'Suporte', 'suporte@hcode.com.br', 1112345678);
...
INSERT INTO `tb_products` (`idproduct`, `desproduct`, `vlprice`, `vlwidth`, `vlheight`, `vllength`, `vlweight`, `desurl`) VALUES
(1, 'Smartphone Android 7.0', '999.95', '75.00', '151.00', '80.00', '167.00', 'smartphone-android-7.0'),
(2, 'SmartTV LED 4K', '3925.99', '917.00', '596.00', '288.00', '8600.00', 'smarttv-led-4k'),
...
INSERT INTO `tb_users` (`iduser`, `idperson`, `deslogin`, `despassword`, `inadmin`) VALUES
(1, 1, 'admin', '$2y$12$YlooCyNvyTji8bPRcrfNfOKnVMmZA9ViM2A3IpFjmrpIbp5ovNmga', 1),
(7, 7, 'suporte', '$2y$12$HFjgUm/mk1RzTy4ZkJaZBe0Mc/BA2hQyoUckvm.lFa6TesjtNpiMe', 1);
...
INSERT INTO `tb_userspasswordsrecoveries` (`idrecovery`, `iduser`, `desip`, `dtrecovery`) VALUES
(1, 7, '127.0.0.1', NULL),
(2, 7, '127.0.0.1', '2017-03-15 13:33:45'),
(3, 7, '127.0.0.1', '2017-03-15 13:37:35');
...
--
ALTER TABLE `tb_orders`
  ADD CONSTRAINT `fk_orders_carts` FOREIGN KEY (`idcart`) REFERENCES `tb_carts` (`idcart`),
  ADD CONSTRAINT `fk_orders_ordersstatus` FOREIGN KEY (`idstatus`) REFERENCES `tb_ordersstatus` (`idstatus`),
  ADD CONSTRAINT `fk_orders_users` FOREIGN KEY (`iduser`) REFERENCES `tb_users` (`iduser`);

--
-- Restrições para tabelas `tb_productscategories`
--
ALTER TABLE `tb_productscategories`
  ADD CONSTRAINT `fk_productscategories_categories` FOREIGN KEY (`idcategory`) REFERENCES `tb_categories` (`idcategory`),
  ADD CONSTRAINT `fk_productscategories_products` FOREIGN KEY (`idproduct`) REFERENCES `tb_products` (`idproduct`);
